...
public sealed class LongHorizonCheckpointGrowthNextWindowTests
{
    ...
    private sealed class CapturingGrowthMaterializer : ILongHorizonRollingGeWindowMaterializer
    {
        ...
        public IReadOnlyList<LongHorizonGeWeekNumericResult> Materialize(IReadOnlyList<LongHorizonGeWeekDescriptor> weeks, LongHorizonGeEntryBaselineInput baseline)
