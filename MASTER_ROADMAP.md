...
[Next, not yet scheduled]       → Narrow EVIDENCE + PRODUCT/NUMERIC AUTHORITY DECISION for the LongHorizon
                                    GE segment's own 5D weekly structure/numeric coefficients. Then the
