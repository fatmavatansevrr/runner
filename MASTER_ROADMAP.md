...
| **Advanced** | `PUBLICLY_ACTIVE` (Core/Runway/LongHorizon; GEN.10) | `PUBLICLY_ACTIVE` (Core/Runway/LongHorizon; GEN.10) | `PUBLICLY_ACTIVE`, full horizon (Core/Runway/LongHorizon; GEN.10) | `PUBLICLY_ACTIVE`, full horizon (Core/Runway/LongHorizon; GEN.10) | `PRODUCT_NON_SUPPORT` (GEN.7 — inherited frequency-global calendar gap) |
