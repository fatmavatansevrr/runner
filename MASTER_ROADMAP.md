...
| **Advanced** | `IMPLEMENTED_AND_DARK_VERIFIED` (GEN.9 — not publicly activated) | `IMPLEMENTED_AND_DARK_VERIFIED` (GEN.9 — not publicly activated) | `IMPLEMENTED_AND_DARK_VERIFIED` (GEN.9 — real PostgreSQL lifecycle proven, not publicly activated) | `IMPLEMENTED_AND_DARK_VERIFIED` (GEN.9 — shares 5D's dual-KEY content, not publicly activated) | `PRODUCT_NON_SUPPORT` (GEN.7 — inherited frequency-global calendar gap) |
