...
**This proposal is provisional, not final authority. Phase F (completing 2D's remaining scope — binding, volume/long-run planning, Adaptation, Runway, LongHorizon) does not proceed until a human sign-off is given and ledgered as final.**
